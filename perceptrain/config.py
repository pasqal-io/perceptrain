...
from perceptrain.blocks.analog import AnalogBlock
from perceptrain.blocks.primitive import ParametricBlock
from perceptrain.operations import RX, AnalogRX
from perceptrain.parameters import Parameter
from perceptrain.types import (
    AnsatzType,
    BasisSet,
...
class FeatureMapConfig:
    ...
    same layer of the feature maps. Takes perceptrain.ReuploadScaling.
    ...
    Takes perceptrain.MultivariateStrategy.
